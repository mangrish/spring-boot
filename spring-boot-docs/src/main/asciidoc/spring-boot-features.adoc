...
You can inject an auto-configured `Session` instance
...
`org.neo4j.ogm.config.Configuration` `@Bean` of your own.
...
[source,java,indent=0]
----
    @EnableExperimentalNeo4jRepositories(basePackages = "com.example.myapp.repository")
