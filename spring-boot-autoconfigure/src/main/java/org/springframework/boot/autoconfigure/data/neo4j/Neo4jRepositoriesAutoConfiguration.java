 ...
 * Repositories.
 * Activates when there is no bean of type {@link Neo4jRepositoryFactoryBean} configured in the
 * context, the Spring Data Neo4j {@link Neo4jRepository} type is on the
 * classpath, the Neo4j client driver API is on the classpath, and there is no other
 * configured {@link Neo4jRepository}.
 * Once in effect, the auto-configuration is the equivalent of enabling Neo4j repositories
 * using the {@link EnableExperimentalNeo4jRepositories}
 * annotation.
 * This configuration class will activate <em>after</em> the Neo4j OGM auto-configuration.
 *
 * @author Dave Syer
 * @author Oliver Gierke
 * @author Josh Long
 * @author Mark Angrish
 * @see EnableExperimentalNeo4jRepositories
 * @since 1.4.0
 */
@Configuration
...
@AutoConfigureAfter(Neo4jOgmAutoConfiguration.class)
